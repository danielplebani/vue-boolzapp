...
createApp({
      ...
      contacts: [
        ...
        },
        {
          ...
          messages: [
              {
                  date: '10/01/2020 15:30:55',
                  message: 'Fai gli auguri a Martina che è il suocompleanno!',
                  status: 'sent'
              },
              {
                  date: '10/01/2020 15:50:00',
                  message: 'Grazie per avermelo ricordato, le scrivosubito!',
                  status: 'received'
              }
          ],
        },
  ...
  methods:{  
    ...
    autoAnswer() {
        setTimeout(() => {
            this.contacts[this.activeChat].messages.push({date: 'now', message: 'ok!', status: 'received'});
    }, 1000)
    },
